...
// ─── Booking row with expandable charges ──────────────────────────────────────
...
// ─── Past week collapsible row ────────────────────────────────────────────────

function PastWeekRow({ report, staffId }: { report: WeeklyRevenueReport; staffId: string }) {
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4 py-2">
            <div className="bg-muted/40 rounded-lg p-4 space-y-1">
              ...
              <p className="text-sm font-medium">Grand Total: <span className="font-semibold text-emerald-700">{formatGHS(grandRevenue)}</span></p>
