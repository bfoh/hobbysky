...
import { Printer, Mail, MessageSquare, Download, Share2 } from '@/components/icons'
...
export function QRCodeGenerator() {
    ...
    const [emailSubject, setEmailSubject] = useState("Hobbysky Guest House QR Code")
        ...
        try {
            ...
            const response = await fetch('/.netlify/functions/send-email', {
                ...
                body: JSON.stringify({
                    ...
                    html: `
                        <h2>Here is the QR Code for Hobbysky Guest House</h2>
                        <p>Scan this code to visit our website.</p>
                        <p>Or visit: <a href="${url}">${url}</a></p>
                    `,
                    attachments: [
                        {
                            filename: 'hobbysky-qr.png',
    ...
    const handleSendSMS = async () => {
        ...
        try {
            const response = await fetch('/.netlify/functions/send-sms', {
                ...
                body: JSON.stringify({
                    to: smsTo,
                    message: `Visit Hobbysky Guest House website here: ${url}`
                })
            });
