          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg overflow-hidden">
                <img src="/logohobbyskydarkmode.png" alt="Hobbysky Guest House" className="w-full h-full object-contain" />
              </div>
              <div>
                <h1 className="text-3xl font-bold">Hobbysky Guest House</h1>
