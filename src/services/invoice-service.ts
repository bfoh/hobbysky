...
<div class="hd">
  <div class="hi">
    ${logoDataUrl ? `<img src="${logoDataUrl}" alt="${invoiceData.hotel.name}" class="lg">` : `<h1>${invoiceData.hotel.name}</h1>`}
    <p>${invoiceData.hotel.address}</p>
    <p>Tel: 0243512529 &nbsp;|&nbsp; ${invoiceData.hotel.email}</p>
  </div>
  <div class="im">
...
<div class="hd">
  <div class="hi">
    ${logoDataUrl ? `<img src="${logoDataUrl}" alt="${preInvoiceData.hotel.name}" class="lg">` : `<h1>${preInvoiceData.hotel.name}</h1>`}
    <p>${preInvoiceData.hotel.address}</p>
    <p>Tel: 0243512529 &nbsp;|&nbsp; ${preInvoiceData.hotel.email}</p>
  </div>
  <div class="im">
...
/**
 * Fetches the hotel logo from the public folder and returns it as a base64 data URL.
 * Using a data URL ensures html2canvas can render the image reliably without CORS issues.
 */
...
<div class="hd">
  <div class="hi">
    ${logoDataUrl ? `<img src="${logoDataUrl}" alt="${data.hotel.name}" class="lg">` : `<h1>${data.hotel.name}</h1>`}
    <p>${data.hotel.address}</p>
    <p>Tel: 0243512529 &nbsp;|&nbsp; ${data.hotel.email}</p>
  </div>
  <div class="im">
