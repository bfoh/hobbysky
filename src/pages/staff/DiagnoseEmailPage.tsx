...
import { Loader2, Mail, Terminal, AlertTriangle, CheckCircle2, XCircle } from '@/components/icons'
    ...
    const handleTestEmail = async () => {
        ...
        try {
            ...
            const result = await sendTransactionalEmail({
                to: email,
                subject: 'Hobbysky Guest House - Diagnostic Test Email',
                html: `
          <div style="font-family: sans-serif; padding: 20px; background: #f4f4f4;">
            <div style="background: white; padding: 20px; border-radius: 8px;">
              <h2 style="color: #8B4513;">Test Email</h2>
              <p>This is a diagnostic test email from your Hobbysky Guest House system.</p>
              <p><strong>Time:</strong> ${new Date().toLocaleString()}</p>
              <p>If you are reading this, the email service is working correctly! ✅</p>
            </div>
          </div>
        `,
                text: 'This is a diagnostic test email from Hobbysky Guest House. If you received this, it works!'
            })
