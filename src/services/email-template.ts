...
<body style="${EMAIL_STYLES.body}">
  ...
  <div style="${EMAIL_STYLES.container}">
    ...
    <div style="${EMAIL_STYLES.header}">
      <img src="https://hobbysky.com/logohobbyskydarkmode.png" alt="Hobbysky Guest House" style="${EMAIL_STYLES.logo}" />
      <h1 style="${EMAIL_STYLES.headerTitle}">Hobbysky Guest House</h1>
    ...
    <div style="${EMAIL_STYLES.footer}">
      <p style="margin: 0 0 10px 0;">&copy; ${year} Hobbysky Guest House Hotel Management System. All rights reserved.</p>
