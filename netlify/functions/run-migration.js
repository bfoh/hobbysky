...
-- ── Migration 3: Inventory & Accountability ───────────────────────────────────
...
CREATE POLICY IF NOT EXISTS "Allow authenticated users to manage inventory items"
...
CREATE POLICY IF NOT EXISTS "Allow authenticated users to view inventory logs"
